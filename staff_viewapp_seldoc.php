...
<main class="mdl-layout__content">
	<div class="mdl-grid page-content" id = "box1">
		<div class="mdl-cell mdl-cell--6-col">
			...
			<center>
				<div id="dropdown-menu" style="position: relative; width: 70%; height: auto; margin-left: auto; margin-right: auto;">
					<div class="form-group">
						<label for="s1">เลือกแผนกที่ต้องการค้นหา</label>
					...
					<br>
					<div class="form-group">
						<label for="s1">เลือกแพทย์ที่ต้องการดูนัดหมาย</label>
						<select id="s1" class="form-control">
			...
			<center>
				<a href="staff_viewapp_seldate.php" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored">
					ต่อไป
				</a>
			</center>
